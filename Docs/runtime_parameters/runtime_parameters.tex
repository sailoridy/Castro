...
\begin{center}
\begin{longtable}{|l|p{5.25in}|l|}
\caption[castro :  simulation control
 parameters]{castro :  simulation control
 parameters} \label{table: castro :  simulation control
 parameters runtime} \\
%
\hline \multicolumn{1}{|c|}{\textbf{parameter}} & 
       \multicolumn{1}{ c|}{\textbf{description}} & 
...
\rowcolor{tableShade}
\runparamNS{T\_stopping\_criterion}{castro} &  Stop the simulation if the maximum temperature on the domain crosses this threshold. Not applied if <= 0. & -1.e200 \\
\runparamNS{ts\_te\_stopping\_criterion}{castro} &  Stop the simulation if the maximum t_sound / t_enuc on the domain crosses this threshold. Not applied if <= 0. & -1.e200 \\
