module advection_util_module
  ...
  public normalize_species_fluxes, divu, limit_hydro_fluxes_on_small_dens, &
         enforce_minimum_density, compute_cfl, ctoprim, srctoprim
...
contains
  ...
  subroutine normalize_species_fluxes(flux1,flux1_lo,flux1_hi, &
    ...
    ! Normalize the fluxes of the mass fractions so that they sum to 0.
    ! This is essentially the CMA procedure that is defined in Plewa &
    ! Muller, 1999, A&A, 342, 179.
