    ...
    do    k = lo(3)-1, hi(3)+1
       do j = lo(2)  , hi(2) 
          ...
          do i = lo(1)-1, hi(1)
             ...
             ekenlx = HALF*rrlx*(qxm(i+1,j,k,QU)**2 + qxm(i+1,j,k,QV)**2 + qxm(i+1,j,k,QW)**2)
    ...
    do       k = lo(3), hi(3)+1
       do    j = lo(2), hi(2) 
          do i = lo(1), hi(1)
             ...
             ! Reset to original value if adding transverse terms made density negative
             if (transverse_reset_density == 1 .and. rrnewr .lt. ZERO) then
                rrnewr = rrr 
                runewr = rur 
                rvnewr = rvr 
                rwnewr = rwr 
    ...
    do       k = lo(3)-1, hi(3)
       do    j = lo(2)  , hi(2) 
          do i = lo(1)  , hi(1)
             ...
             ekenl = HALF*rrl*(qm(i,j,k+1,QU)**2 + qm(i,j,k+1,QV)**2 + qm(i,j,k+1,QW)**2)
             ...
             ! Reset to original value if adding transverse terms made density negative
             if (transverse_reset_density == 1 .and. rrnewl .lt. ZERO) then
                rrnewl = rrl 
                runewl = rul 
                rvnewl = rvl 
                rwnewl = rwl 
    ...
    do    k = lo(3), hi(3)
       do j = lo(2), hi(2) 
          ...
          do i = lo(1)-1, hi(1)
             ...
             ekenl = HALF*rrl*(qm(i+1,j,k,QU)**2 + qm(i+1,j,k,QV)**2 + qm(i+1,j,k,QW)**2)
